...
const VendorRegister = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-green-400 to-green-00 "></div>
      </div>

      {/* Content */}
      <div className="relative z-10">
        <div className="px-8 py-6">
          <h1 className="text-4xl font-bold text-green-600">Dealsy</h1>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-gray-900">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-green-500 hover:bg-green text-white py-3 px-4 rounded-full font-semibold focus:outline-none focus:ring-2 focus:ring-[#6B4E4E] transition duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
