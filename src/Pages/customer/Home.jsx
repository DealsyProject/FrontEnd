...
export default function Home() {
  ...
  const brands = [
    "public/Trusted Logos/Logo1.png", "public/Trusted Logos/logo2.png", "public/Trusted Logos/logo3.png", "public/Trusted Logos/logo4.png", "public/Trusted Logos/logo5.png", "public/Trusted Logos/logo6.png"
  ];
      ...
      <section className="relative bg-white flex flex-col items-center py-0 overflow-hidden min-h-[400px]">
        ...
        <div className="relative z-10 w-full flex justify-center pb-0 pt-2">
          <div className="bg-black overflow-hidden border-t-10 border-x-10 border-b-0 border-black w-[35vw] max-w-3xl min-w-[350px] rounded-t-xl rounded-b-none">
            <img
              src="public\homepics\browseSection.png"  // <-- Use your actual imagefilename here!
              alt="Product Display"
      ...
      <section className="py-12 overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex animate-scroll gap-16">
            {/* Repeat logos twice for continuous scrolling effect */}
