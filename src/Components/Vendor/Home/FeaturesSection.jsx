const FeaturesSection = () => {
  return (
    <section className="py-12  text-[#586330]/90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-2xl font-bold text-green text-center mb-12">Why Choose Dealsy?</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          
          {/* Feature 1: Verified Customers */}
          <div className="text-center">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-[#586330]/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
